/* 2013-04-11 */
define("slidesjs/3.0.3/slidesjs-debug", [], function(require, exports) {
    /*
SlidesJS 3.0.3
...
*/
    ...
    Plugin.prototype._touchend = function(e) {
        ...
        touches = e.originalEvent.touches[0];
        slidesControl = $(".slidesjs-control", $element);
        if (slidesControl.position().left > this.options.width * .5 || slidesControl.position().left > this.options.width * .1 && Number(new Date()) - this.data.touchtimer < 250) {
            $.data(this, "direction", "previous");
            this._slide();
        } else if (slidesControl.position().left < -(this.options.width * .5) || slidesControl.position().left < -(this.options.width * .1) && Number(new Date()) - this.data.touchtimer < 250) {
            $.data(this, "direction", "next");
            this._slide();
        } else {
