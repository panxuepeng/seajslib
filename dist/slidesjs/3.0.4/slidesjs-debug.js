/* 2013-07-08 */
define("slidesjs/3.0.4/slidesjs-debug", [], function(require, exports) {});
...
(function() {
    (function($, window, document) {
        ...
        Plugin.prototype.init = function() {
            ...
            if (this.data.touch) {
                $($element).delegate(".slidesjs-control", "touchstart", function(e) {
                    return _this._touchstart(e);
                });
                $($element).delegate(".slidesjs-control", "touchmove", function(e) {
                    return _this._touchmove(e);
                });
                $($element).delegate(".slidesjs-control", "touchend", function(e) {
