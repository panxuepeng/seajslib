/*
 * autocomplete
 * https://github.com/Administrator/autocomplete
 *
 * Copyright (c) 2013 
 * Licensed under the MIT license.
 */
define("autocomplete/2.4.4/autocomplete-debug", [], function(require, exports) {
    require.async("./autocomplete-debug.css");
    $(document).delegate("input[data-toggle=autocomplete]", "keydown.autocomplete", function(e) {
        var o = $(e.target), data = o.data();
        if (!data.autocomplete) {
            o.autocomplete(data.url, {
                minChars: 1
            });
            o.data("autocomplete", "1");
        }
    });
});
...
(function($) {
    ...
    $.Autocompleter.prototype.position = function() {
        ...
        var totalHeight = $(window).outerHeight() + $(document).scrollTop();
