/* 2013-04-11 */
define("imgfall/1.0.0/image", [], function(require, exports) {
...
define("imgfall/1.0.0/imgfall", [ "./image", "./panel" ], function(require, exports) {
...
define("imgfall/1.0.0/panel", [], function(require, exports) {
    ...
    var PanelShow = Backbone.View.extend({
        ...
        render: function() {
            var template = _.template($("#panel-container").html(), {
                panel: this.model.attributes
            });
            $(this.el).append(template);
        }
    });
